...
public class Quiz extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.quiz, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((Quiz) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
	...
	{
		Intent j = new Intent(getApplicationContext(), India.class);
		startActivity(j);
	...
	{
		Intent j = new Intent(getApplicationContext(), Sudoku.class);
		startActivity(j);
		
	}
	public void writing(View v)
	{
		Intent j = new Intent(getApplicationContext(), Writing.class);
		startActivity(j);
		
	}
	public void treasure(View v)
	{
		Intent j = new Intent(getApplicationContext(), Treasure.class);
		startActivity(j);
