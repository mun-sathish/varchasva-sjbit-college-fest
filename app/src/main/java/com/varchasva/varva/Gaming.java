...
public class Gaming extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.gaming, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((Gaming) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
	...
	public void counterstrike(View v)
	{
		Intent j = new Intent(getApplicationContext(), Counterstrike.class);
		startActivity(j);
		
	}
	public void nfs(View v)
	{
		Intent j = new Intent(getApplicationContext(), Nfs.class);
		startActivity(j);
	}

	public void dota(View v)
	{
		Intent j = new Intent(getApplicationContext(), Dota.class);
		startActivity(j);
	}

	public void roadrash(View v)
	{
		Intent j = new Intent(getApplicationContext(), Roadrash.class);
		startActivity(j);
	}
	public void fifa(View v)
	{
		Intent j = new Intent(getApplicationContext(), Fifa.class);
		startActivity(j);
	}
	public void spotclick(View v)
	{
		Intent j = new Intent(getApplicationContext(), Spotclick.class);
		startActivity(j);
	}
	public void call(View v)
	{
		Intent j = new Intent(getApplicationContext(), Callofduty.class);
		startActivity(j);
	}
