...
public class Sponsor extends Activity implements
	...
	public void onSectionAttached(int number) {
		...
		case 15:
			...
			//Toast.makeText(getApplicationContext(), "Check Back Soon... Not updated!!!", Toast.LENGTH_LONG).show();
			//Intent s= new Intent(getApplicationContext(),Sponsors.class);
			//startActivity(s);
			break;
		case 16:
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.sponsor, container,
					false);
			Typeface e1 = Typeface.createFromAsset(getActivity().getAssets(), "font/AllAgesDEMO.ttf");
			TextView event1= (TextView) r.findViewById(R.id.event1);
			event1.setTypeface(e1);
			Typeface e2 = Typeface.createFromAsset(getActivity().getAssets(), "font/AllAgesDEMO.ttf");
		...
		public void onAttach(Activity activity) {
			...
			((Sponsor) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
