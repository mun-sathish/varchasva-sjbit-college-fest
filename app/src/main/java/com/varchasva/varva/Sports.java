...
public class Sports extends Activity implements
	...
	public void onSectionAttached(int number) {
		...
		case 7:
			...
			Intent z = new Intent(getApplicationContext(),Dance.class);
			startActivity(z);
			break;
		case 8:
			//mTitle = getString(R.string.title_section7);
			Intent l = new Intent(getApplicationContext(),Music.class);
			startActivity(l);
			break;
		case 9:
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.sports, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((Sports) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
	...
	public void minicricket(View v) {

		Intent j = new Intent(getApplicationContext(), Minicricket.class);
		startActivity(j);
	}

	public void minibasketball(View v) {
		Intent j = new Intent(getApplicationContext(), Minibasketball.class);
		startActivity(j);

	}

	public void minifootball(View v) {
		Intent j = new Intent(getApplicationContext(), Minifootball.class);
		startActivity(j);
	}

	public void minivolleyball(View v) {
		Intent j = new Intent(getApplicationContext(), Minivolleyball.class);
		startActivity(j);

	}
	public void lagori(View v) {
		Intent j = new Intent(getApplicationContext(), Lagori.class);
		startActivity(j);

	}
	public void tugofwar(View v) {
		Intent j = new Intent(getApplicationContext(), Tugofwar.class);
		startActivity(j);
