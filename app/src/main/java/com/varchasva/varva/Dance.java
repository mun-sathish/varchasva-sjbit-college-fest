...
public class Dance extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.dance, container,
					false);
			...
			Typeface e8 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[2]);
			TextView event8= (TextView) r.findViewById(R.id.event8);
			event8.setTypeface(e8);
			Typeface e9 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[6]);
			TextView event9= (TextView) r.findViewById(R.id.event9);
		...
		public void onAttach(Activity activity) {
			...
			((Dance) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
	...
	{
		Intent j = new Intent(getApplicationContext(), Western.class);
		startActivity(j);
		
	}
	public void eastern(View v)
	{
		Intent j = new Intent(getApplicationContext(), Eastern.class);
		startActivity(j);
		
	}
	
	public void jodino(View v)
	{
		Intent j = new Intent(getApplicationContext(), Jodino.class);
		startActivity(j);
		
	}
	public void solodance(View v)
	{
		Intent j = new Intent(getApplicationContext(), Solodance.class);
		startActivity(j);
		
	}
	
	public void soloadap(View v)
	{
		Intent j = new Intent(getApplicationContext(), Soloadap.class);
		startActivity(j);
