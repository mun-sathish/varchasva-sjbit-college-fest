...
public class Dumbcharades extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.dumbcharades, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((Dumbcharades) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
