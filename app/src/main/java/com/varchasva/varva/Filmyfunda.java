...
public class Filmyfunda extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.filmyfunda, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((Filmyfunda) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
