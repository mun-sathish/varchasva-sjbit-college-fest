...
import android.widget.Toast;
	...
	public class Music extends Activity implements
		...
		public static class PlaceholderFragment extends Fragment {
			...
			public View onCreateView(LayoutInflater inflater, ViewGroup container,
				...
				View r = inflater.inflate(R.layout.music, container,
						false);
			...
			public void onAttach(Activity activity) {
				...
				((Music) activity).onSectionAttached(getArguments().getInt(
						ARG_SECTION_NUMBER));
			}
		}
	...
	public void bands(View v)
	{
		Intent j = new Intent(getApplicationContext(), Bands.class);
		startActivity(j);
		
	}
	public void inssolo1(View v)
	{
		Intent j = new Intent(getApplicationContext(), Inssolo1.class);
		startActivity(j);
		
	}
	public void inssolo2(View v)
	{
		Intent j = new Intent(getApplicationContext(), Inssolo2.class);
		startActivity(j);
		
	}
	public void vocal(View v)
	{
		Intent j = new Intent(getApplicationContext(), Vocal.class);
		startActivity(j);
