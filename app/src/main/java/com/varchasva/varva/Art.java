...
public class Art extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.art, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((Art) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
	...
	{
		Intent j = new Intent(getApplicationContext(), Rangoli.class);
		startActivity(j);
		
	}
	public void mehandi(View v)
	{
		Intent j = new Intent(getApplicationContext(), Mehandi.class);
		startActivity(j);
		
	}
	public void sketching(View v)
	{
		Intent j = new Intent(getApplicationContext(), Sketching.class);
		startActivity(j);
		
	}
	public void face(View v)
	{
		Intent j = new Intent(getApplicationContext(), Face.class);
		startActivity(j);
