...
public class BigEvents extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.bigevents, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((BigEvents) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
	...
	{
		Intent j = new Intent(getApplicationContext(), Bike.class);
		startActivity(j);
	}

	public void street(View v)
	{
		Intent j = new Intent(getApplicationContext(), Street.class);
		startActivity(j);
	}

	public void djnight(View v) 
	{
		Intent j = new Intent(getApplicationContext(), Djnight.class);
		startActivity(j);
	...
	{
		Intent j = new Intent(getApplicationContext(), Fashion.class);
		startActivity(j);
