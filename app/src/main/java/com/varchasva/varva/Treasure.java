...
public class Treasure extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.treasure, container,
					false);
		...
		public void onAttach(Activity activity) {
			...
			((Treasure) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
