...
public class Developers extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.developers, container,
					false);
			
			
			Typeface sat = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[11]);
			TextView sathish= (TextView) r.findViewById(R.id.sathish);
			sathish.setTypeface(sat);
			
			Typeface yug = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[11]);
			TextView yogesh= (TextView) r.findViewById(R.id.yogesh);
			yogesh.setTypeface(yug);
			
			Typeface dev = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[3]);
			TextView developers= (TextView) r.findViewById(R.id.developers);
			developers.setTypeface(dev);
			
			Typeface e4 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[3]);
			TextView event4= (TextView) r.findViewById(R.id.event4);
			event4.setTypeface(e4);
			
			Typeface e5 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[11]);
		...
		public void onAttach(Activity activity) {
			...
			((Developers) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
