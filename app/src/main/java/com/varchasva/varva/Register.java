...
import android.widget.Toast;
	...
	public class Register extends Activity implements
		...
		protected void onCreate(Bundle savedInstanceState) {
			...
			{
				Toast.makeText(getApplicationContext(), "WELCOME TO ENROLLMENT OF TICKETS", Toast.LENGTH_LONG).show();
		...
		public static class PlaceholderFragment extends Fragment {
			...
			public View onCreateView(LayoutInflater inflater, ViewGroup container,
				...
				View r = inflater.inflate(R.layout.register, container,
						false);
				Typeface e1 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[14]);
			...
			public void onAttach(Activity activity) {
				...
				((Register) activity).onSectionAttached(getArguments().getInt(
						ARG_SECTION_NUMBER));
			}
		}
	...
	{
		Intent j = new Intent(getApplicationContext(), Enroll.class);
		startActivity(j);
		finish();
	}
