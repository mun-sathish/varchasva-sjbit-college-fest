...
public class Informal extends Activity implements
	...
	public static class PlaceholderFragment extends Fragment {
		...
		public View onCreateView(LayoutInflater inflater, ViewGroup container,
			...
			View r = inflater.inflate(R.layout.informal, container,
					false);
			Typeface e1 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[2]);
			TextView event1= (TextView) r.findViewById(R.id.event1);
			event1.setTypeface(e1);
			Typeface e2 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[8]);
			Button event2= (Button) r.findViewById(R.id.event2);
			event2.setTypeface(e2);
			Typeface e3 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[8]);
			Button event3= (Button) r.findViewById(R.id.event3);
			event3.setTypeface(e3);
			Typeface e4 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[8]);
			TextView event4= (TextView) r.findViewById(R.id.event4);
			event4.setTypeface(e4);
			
			Typeface e5 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[8]);
			Button event5= (Button) r.findViewById(R.id.event5);
			event5.setTypeface(e5);  
			Typeface e6 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[8]);
			Button event6= (Button) r.findViewById(R.id.event6);
			event6.setTypeface(e6);
			Typeface e7 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[8]);
			TextView event7= (TextView) r.findViewById(R.id.event7);
			event7.setTypeface(e7);
			Typeface e8 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[8]);
		...
		public void onAttach(Activity activity) {
			...
			((Informal) activity).onSectionAttached(getArguments().getInt(
					ARG_SECTION_NUMBER));
		}
	}
	...
	public void madads(View v)
	{
		Intent j = new Intent(getApplicationContext(), Madads.class);
		startActivity(j);
	}
	public void hogothon(View v)
	{
		Intent j = new Intent(getApplicationContext(), Hogothon.class);
		startActivity(j);
	}
	public void dumbcharades(View v)
	{
		Intent j = new Intent(getApplicationContext(), Dumbcharades.class);
		startActivity(j);
	}
	public void collage(View v)
	{
		Intent j = new Intent(getApplicationContext(), Collage.class);
		startActivity(j);
	}
	public void filmyfunda(View v)
	{
		Intent j = new Intent(getApplicationContext(), Filmyfunda.class);
		startActivity(j);
	}
	public void antakshari(View v)
	{
		Intent j = new Intent(getApplicationContext(), Antakshari.class);
		startActivity(j);
	}
	public void slowdrag(View v)
	{
		Intent j = new Intent(getApplicationContext(), Slowdrag.class);
		startActivity(j);
	}
