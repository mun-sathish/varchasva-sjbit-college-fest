...
import android.widget.Toast;
	...
	public class Rules extends Activity implements
		...
		public static class PlaceholderFragment extends Fragment {
			...
			public View onCreateView(LayoutInflater inflater, ViewGroup container,
				...
				View r = inflater.inflate(R.layout.rules, container,
						false);
				...
				Typeface e2 = Typeface.createFromAsset(getActivity().getAssets(), "font/"+style[14]);
			...
			public void onAttach(Activity activity) {
				...
				((Rules) activity).onSectionAttached(getArguments().getInt(
						ARG_SECTION_NUMBER));
			}
		}
